---
title: "Predicting Yearly Salary for NBA Players: 1990-2017"
subtitle: |
  | Final Project 
...
I will be using repeated V-fold cross-validation in this project: 5 folds and 3 repeats to randomly split the data into 5 equal-sized sets, with different performance metrics for each. That process will be repeated thrice. 
...
That difference existed for the feature-engineered ones, though another primary difference was that the feature-engineered tree-based recipe did NOT include interactions, transformations, and splines, while the non-parametric one did.
...
Additionally, I used step_novel() since the team variable had around 35 factor levels (leaving a chance that there'd be a new level appearing, so wanted to use it just in case), and then used step_dummy() to make sure my categorical variable data would be stored in a binary way for the models to run. From there, I added steps to filter out zero-variance and near-zero variance to eliminate potential imbalance, before normalizing all of my predictors to cap it off.
...
I also applied a square (as in raising to the second power) transformation through a mutating step to lessen a left skew for free throw percentage.

I then added a cut step to designate the "season start" numeric variable into a factor divided into five-year range bins from 1990-1995, '96-2000, and so on until getting to 2015-17. I'll justify this in the EDA appendix, but the gist of that was to consider the gradual rise of the salary cap in the NBA for different eras. After making my categorical predictors into binary terms and considering potential new factor levels with step_novel, I added interactions to account for different bivariate and multivariate relationships within the data to affect log-transformed salary.
...
Clearly, simply going off of the mean (particularly in a sport where salaries constantly increase) isn't a great way of predicting how much a player makes (or should make). Therefore, building the models and selecting a well-performing one is well-worthwhzile to explore this predictive question.
...
## References (in order of footnotes)

Blanco, F. "NBA - Advanced & Basic Season Stats (1950-2017)." Kaggle. https://www.kaggle.com/datasets/whitefero/nba-players-advanced-season-stats-19782016. 

"NBA Active Player Contracts, 2010." Spotrac. https://www.spotrac.com/nba/contracts/sort-value/all-time/start-2010/limit-100/.

Associated Press (18 Feb 2010). "Nets to play two years in Newark." ESPN.com. https://www.espn.com/nba/news/story?id=4925915.

chamrochinski (20 May 2014). "Charlotte Hornets Name Returns to Carolinas." NBA.com. https://www.nba.com/hornets/charlotte-hornets-name-returns-carolinas. 

The Sports XChange (24 January 2013). "New Orleans officially changes its nickname to Pelicans next season." Yahoo Sports. https://sports.yahoo.com/news/orleans-officially-changes-nickname-pelicans-233005547--nba.html. 

Michel, Riley (2 July 2019). "On this day: The Seattle SuperSonics officially move to Oklahoma City in 2008." KIRO 7. https://www.kiro7.com/sports/on-this-date-9-years-ago-the-seattle-sonics-moved-to-oklahoma-city/547725919/.

"NBA Timeline and Abbreviatons." SHRP Sports. https://www.shrpsports.com/nba/explain.htm.

Quinn, Sam (3 April 2023). "NBA CBA 101: Everything to know about new agreement, from salary cap to free agency and beyond." CBS Sports. https://www.cbssports.com/nba/news/nba-cba-101-everything-to-know-about-new-agreement-from-salary-cap-to-free-agency-and-beyond/.

Bouranis, Yiannis (3 October 2023). "Top 5 biggest contracts in Spurs history ft Tim Duncan, Kawhi Leonard & more." Sportskeeda. https://www.sportskeeda.com/basketball/top-5-biggest-contracts-spurs-history-ft-tim-duncan-kawhi-leonard.
