# 3: Tuning elastic net model, feature-engineered recipe  ----
...
tuned_elastic_fe <- tune_grid(elastic_workflow,
                                   nba_folds,
                                   grid = elastic_grid,
...
# saving tune
save(tuned_elastic_fe, file = here("results/tuned_elastic_fe.rda"))